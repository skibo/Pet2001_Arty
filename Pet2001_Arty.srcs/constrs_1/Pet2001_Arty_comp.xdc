...
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { COMPVID[0] }]; #IO_L10N_T1_AD11N_15 Sch=ja[9]
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { COMPVID[1] }]; #IO_25_15 Sch=ja[10]


##Pmod Header JB

#set_property -dict { PACKAGE_PIN E15   IOSTANDARD LVCMOS33 } [get_ports { jb[1] }]; #IO_L11P_T1_SRCC_15 Sch=jb[1]
#set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { jb[2] }]; #IO_L11N_T1_SRCC_15 Sch=jb[2]
#set_property -dict { PACKAGE_PIN D15   IOSTANDARD LVCMOS33 } [get_ports { jb[3] }]; #IO_L11N_T1_MRCC_15 Sch=jb[3]
#set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { jb[4] }]; #IO_L11P_T1_MRCC_15 Sch=jb[4]
#set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS33 } [get_ports { jb[7] }]; #IO_L23P_T3_FOE_B_15 Sch=jb[7]
#set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { jb[8] }]; #IO_L23N_T3_FWE_B_15 Sch=jb[8]
#set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { jb[9] }]; #IO_L24P_T3_RS1_15 Sch=jb[9]
#set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { jb[10] }]; #IO_L24N_T3_RS0_15 Sch=jb[10]
...
set_property -dict { PACKAGE_PIN D4    IOSTANDARD LVCMOS33 } [get_ports { AUDIO }]; #IO_L11N_T1_SRCC_35 Sch=jd[1]
