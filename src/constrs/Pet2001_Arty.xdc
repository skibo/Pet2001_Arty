...
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { CVID[0] }]; #IO_L10N_T1_AD11N_15 Sch=ja[9]
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { CVID[1] }]; #IO_25_15 Sch=ja[10]
